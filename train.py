...
def main(args, **model_kwargs):
    ...
    model = STABC.from_args(args, device, supports, aptinit, **model_kwargs)
    # print(model)
    if args.checkpoint:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_range', type=int, default=0, help='when target_range = 0 is global prediction')
